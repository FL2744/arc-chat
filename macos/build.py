...
d.update(CFBundleIdentifier='edu.research.arc-chat.local',CFBundleName='ARC Chat',CFBundleDisplayName='ARC Chat',CFBundleShortVersionString='0.2.2',NSHighResolutionCapable=True)
